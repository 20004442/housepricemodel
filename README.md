...
## RESULT:
Thus the website is designed to train the house price model in the url http://kavya.student.saveetha.in:8000/HouseModelTraining/ and to predict the price in the url http://kavya.student.saveetha.in:8000/HouseModelPrediction/. HTML code is validated.